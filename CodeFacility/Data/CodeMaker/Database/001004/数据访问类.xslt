...
namespace Maticsoft.Interface_<xsl:value-of select="NameDx" />
{
  ...
  ///</summary>
  public class <xsl:value-of select="NameDx" />Service : I<xsl:value-of select="NameDx" />Service
    {
    ...
    /// 增加一条数据
    /// </summary>
    public int Add(<xsl:value-of select="NameDx" />Info info)
    {
      int intNum = 0;
    ...
    /// 更新一条数据
    /// </summary>
    public int Edit(<xsl:value-of select="NameDx" />Info info)
    {
      int intNum = 0;
      // 定义参数
