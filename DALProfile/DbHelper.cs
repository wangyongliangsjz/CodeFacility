...
namespace DALProfile
{
    public abstract class DbHelper
    {
        ...
        public static int Timeout = DBConfig.SqlTimeout;
        ...
        public static int ExecuteNonQueryCurrency(DbConnection connection, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
        ...
        /// <returns></returns>
        public static int ExecuteNonQueryCurrencyTransactions(DbConnection connection, CommandType cmdType, List<string> ListCmdText, params DbParameter[] commandParameters)
        {
            DbCommand cmd = GetDbCommand(connection);
            int val = PrepareCommandTransactions(cmd, connection, null, cmdType, ListCmdText, commandParameters);
            //int val = cmd.ExecuteNonQuery();
            cmd.Parameters.Clear();
            DbHelper.Conn = connection;
            return val;
        ...
        public static DbTransaction GetDbTransaction(DbCommand cmd)
        {
            DbTransaction dtr = null;

            //if (cmd is System.Data.SqlClient.SqlCommand)
            //{
            //    dtr =new System.Data.SqlClient.SqlTransaction();
            ...
            //}
            //else if (cmd is Devart.Data.Oracle.OracleCommand)
            //{

            //}
            //else if (cmd is System.Data.SQLite.SQLiteCommand)
            //{
            ...
            //{
            //    dtr = new System.Data.OleDb.OleDbTransaction();
            //}
            ////if (transaction is Devart.Data.Oracle.OracleTransaction)
            ////{
            ////    dtr = new Devart.Data.Oracle.OracleTransaction();
            ////}
            //if (transaction is System.Data.SQLite.SQLiteTransaction)
            //{
            //    dtr = new System.Data.SQLite.SQLiteTransaction();
            //}
            ////if (transaction is MySql.Data.MySqlClient.MySqlTransaction)
            ////{
            ////    dtr = new MySql.Data.MySqlClient.MySqlTransaction();
            ////}
            return dtr;
        }

        public static DataTable ExecuteTableCurrency(DbConnection conn, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
        ...
        public static DataSet ExecuteDataSetCurrency(DbConnection conn, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
            DbCommand cmd = GetDbCommand(conn);
            DbDataAdapter da = GetDbDataAdapter(conn);
        ...
        private static void PrepareCommandCurrency(DbCommand cmd, DbConnection conn, DbTransaction trans, CommandType cmdType, string cmdText, DbParameter[] cmdParms)
        {
            //if (conn is System.Data.SqlClient.SqlConnection)
            //{
        ...
        private static int PrepareCommandTransactions(DbCommand cmd1, DbConnection conn1, DbTransaction trans, CommandType cmdType, List<string> ListCmdText, DbParameter[] cmdParms)
        {
            using (DbConnection conn = conn1)
            {
                conn.Open();
                DbCommand cmd = cmd1;
                cmd.Connection = conn;
